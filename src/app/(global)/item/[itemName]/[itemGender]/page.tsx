...
export default async function ItemDetailPage({
  ...
  const [marketPrice, tradedPrice] = await Promise.all([
    getItemMarketPrice(decodedItemName, decodedItemGender),
    getTradedMarketPrice(decodedItemName, decodedItemGender),
  ]);
